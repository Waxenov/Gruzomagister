...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#FF0015] text-base font-medium leading-5 text-gray-900 focus:outline-none focus:border-[#FF0015] transition duration-150 ease-in-out'
