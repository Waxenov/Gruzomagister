<x-app-layout>
    ...
    <div class="flex">
        <div class="mb-5 px-10">
            ...
            <select class="bg-[#F8EAEA] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#FF0015] focus:border-[#FF0015] block w-full p-2.5" type="text" wire:model="cargoType" name="cargoType" id="cargoType"  required/>
    ...
    <div class="flex">
        <div class="mb-5 px-10">
            ...
            <input class="bg-[#F8EAEA] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#FF0015] focus:border-[#FF0015] block w-full p-2.5" type="text" wire:model="weight" name="weight" id="weight">
        </div>
        <div class="mb-5 px-10">
    ...
    <div class="mb-5">
        ...
        <div class="flex justify-center">
            <button type="button" class="flex justify-center text-white bg-[#FF5267] hover:bg-[#FF0015] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-24 py-2.5 text-center">Создать заказ</button>
        </div>
    </form>
</div>
