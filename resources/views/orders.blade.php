                ...
                <table class="w-full  text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-[#ffffff] text-center border-b-2 border-b-[#EDE3E7]">
                            ...
                            <td class="px-6 py-4 text-[#606060]"> {{ $data->cargo_type }} </td>
                            <td class="px-6 py-4 text-[#606060]"> {{ $data->cargo_describe }} </td>
                            <td class="px-6 py-4 text-[#606060]"> {{ $data->weight }} </td>
                            <td class="px-6 py-4 text-[#606060]"> {{ $data->ready_date }} </td>
