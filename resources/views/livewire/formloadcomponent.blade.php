<div class="flex max-h-full py-5">
    ...
    <div class="flex">
        ...
        <div class="flex justify-center">
            <button type="submit" class="flex justify-center text-white bg-[#FF0015] hover:bg-[#FF5267] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-24 py-2.5 text-center">Создать заказ</button>
        </div>
    </form>
</div>
