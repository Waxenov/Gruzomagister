            ...
            <div class="flex">
                ...
                <div class="hidden space-x-14 sm:-my-px sm:ms-20 sm:flex">
                    ...
                    <x-nav-link href="{{ route('orders') }}" wire:navigate :active="request()->routeIs('orders')">
                        ...
                        <x-nav-link href="{{ route('adminpanel') }}" wire:navigate :active="request()->routeIs('adminpanel')">
                            {{ __('Настройка') }}
                        </x-nav-link>
                        @endif
                    ...
                    <x-nav-link href="{{ route('tarif') }}" wire:navigate :active="request()->routeIs('tarif')">
                        {{ __('Тарифы') }}
                    </x-nav-link>
            ...
            <div class="ms-3 relative">
                <x-dropdown align="right" width="44">
                    <x-slot name="trigger">
                        ...
                        <span class="inline-flex rounded-md">
                            <button type="button" class="justify-end mt-4 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                ...
                                <svg class="w-6 h-6 text-[#FF0015] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M4 4a2 2 0 0 0-2 2v9a1 1 0 0 0 1 1h.535a3.5 3.5 0 1 0 6.93 0h3.07a3.5 3.5 0 1 0 6.93 0H21a1 1 0 0 0 1-1v-4a.999.999 0 0 0-.106-.447l-2-4A1 1 0 0 0 19 6h-5a2 2 0 0 0-2-2H4Zm14.192 11.59.016.02a1.5 1.5 0 1 1-.016-.021Zm-10 0 .016.02a1.5 1.5 0 1 1-.016-.021Zm5.806-5.572v-2.02h4.396l1 2.02h-5.396Z" clip-rule="evenodd"/>
                                </svg><span id="role">{{ Auth::user()->email }}</span>
                                ...
                                </svg><span id="role" class="text-[#FF0015]">ADMINISTRATOR</span>
                    ...
                    <x-slot name="content">
                        ...
                        @auth<div class="border-t border-gray-200"></div>@endauth
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            @csrf
                            @auth
                            <x-dropdown-link href="{{ route('logout') }}" @click.prevent="$root.submit();">
                                <span class="text-[#FF0015]">{{ __('Выйти') }}</span>
                            </x-dropdown-link>
                            @endauth
                        </form>
                    </x-slot>
